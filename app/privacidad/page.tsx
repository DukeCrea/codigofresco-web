...
export const metadata = buildMetadata({
  ...
  description: "Cómo CodigoFresco recopila, utiliza y protege los datos enviados por visitantes y clientes.",
  path: "/privacidad",
  index: false,
});
...
export default function PrivacyPage() {
  return (
    <LegalPage title="Política de privacidad" intro="Explicamos qué datos recopilamos, para qué los usamos y qué opciones tienes sobre su tratamiento.">
      <section><h2>Responsable y contacto</h2><p className="mt-4">CodigoFresco es responsable del tratamiento descrito en esta política. Puedes escribir a <a href={`mailto:${siteConfig.email}`}>{siteConfig.email}</a> para realizar consultas o ejercer tus derechos.</p></section>
