...
export const metadata = buildMetadata({
  ...
  description: "Condiciones generales de uso del sitio web de CodigoFresco y de la información publicada.",
  path: "/terminos",
  index: false,
});
...
export default function TermsPage() {
  return (
    <LegalPage title="Términos de uso" intro="Estas condiciones regulan el acceso al sitio informativo de CodigoFresco. Cada proyecto se rige además por su propuesta o contrato específico.">
      ...
      <section><h2>Propiedad intelectual</h2><p className="mt-4">La identidad, los textos y los materiales propios de CodigoFresco están protegidos. Marcas y tecnologías de terceros pertenecen a sus respectivos titulares.</p></section>
